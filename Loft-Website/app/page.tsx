export default function Home() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-24 md:h-28">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#about" className="text-loft-green hover:text-loft-green/80 font-inter text-base transition-colors duration-200">
                About
              </a>
              <a href="#services" className="text-loft-green hover:text-loft-green/80 font-inter text-base transition-colors duration-200">
                Services
              </a>
              <a href="#courses" className="text-loft-green hover:text-loft-green/80 font-inter text-base transition-colors duration-200">
                Courses
              </a>
              <a href="#contact" className="text-loft-green hover:text-loft-green/80 font-inter text-base transition-colors duration-200">
                Contact
              </a>
      ...
      {/* Main Content */}
      <main className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-36 pb-12 md:pt-44 md:pb-20 bg-loft-off-white overflow-hidden">
        {/* Video Background */}
        <div className="absolute inset-0 w-full h-full z-0">
          ...
          <div className="absolute inset-0 bg-loft-off-white/60 z-10"></div>
        </div>

        {/* Hero Content */}
        <div className="relative z-20 w-full max-w-4xl mx-auto text-center space-y-8 md:space-y-12">
        <section className="space-y-6 md:space-y-8" aria-labelledby="hero-heading">
          <h1 id="hero-heading" className="text-4xl md:text-5xl lg:text-6xl font-playfair text-loft-green">
        ...
        <section className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 pt-8 md:pt-12 border-t border-loft-green/20" aria-label="Key features">
          <div className="space-y-2">
            <div className="text-3xl md:text-4xl font-playfair text-loft-green" aria-label="18 plus">18+</div>
            <div className="text-sm md:text-base text-loft-green/80">Championship Courses</div>
          </div>
          <div className="space-y-2">
            <div className="text-3xl md:text-4xl font-playfair text-loft-green" aria-label="20 minutes">20 min</div>
            <div className="text-sm md:text-base text-loft-green/80">Setup Time</div>
          </div>
          <div className="space-y-2 col-span-2 md:col-span-1">
            <div className="text-3xl md:text-4xl font-playfair text-loft-green">Mobile</div>
